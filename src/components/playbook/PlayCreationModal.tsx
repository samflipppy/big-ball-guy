...
export default function PlayCreationModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" data-testid="play-creation-modal">
      <div
        className={cn(
          'flex flex-col w-full max-w-2xl max-h-[90vh] rounded-xl bg-white shadow-2xl overflow-hidden',
          className,
        )}
      >
        {/* Header */}
        <div className="flex items-center justify-between border-b border-zinc-200 px-6 py-4">
          <div>
            <h2 className="text-lg font-semibold text-zinc-900">Create New Play</h2>
        ...
        {/* Steps indicator */}
        <div className="flex items-center gap-2 px-6 py-3 bg-zinc-50 border-b border-zinc-200">
          <div
            className={cn(
            ...
            <div className="p-6 space-y-4">
              ...
              {selectedFormation && (
                <div className="flex items-center gap-3 rounded-lg bg-blue-50 p-3 border border-blue-200">
                  ...
                  <div>
                    <p className="text-sm font-medium text-blue-800">{selectedFormation.name}</p>
                    <p className="text-xs text-blue-600">{selectedFormation.personnel} personnel</p>
                  </div>
                </div>
              )}
              ...
              {/* Play name */}
              <div>
                <label htmlFor="play-name" className="mb-1 block text-sm font-medium text-zinc-700">
                  Play Name
                </label>
                <input
                  id="play-name"
                  ...
                  className={cn(
                    ...
                    nameError ? 'border-red-400' : 'border-zinc-300',
              ...
              {/* Personnel */}
              <div>
                <label htmlFor="play-personnel" className="mb-1 block text-sm font-medium text-zinc-700">
                  Personnel
                </label>
                <select
                  id="play-personnel"
                  ...
                  className="w-full rounded-lg border border-zinc-300 px-3 py-2 text-sm focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500"
              ...
              {/* Notes */}
              <div>
                <label htmlFor="play-notes" className="mb-1 block text-sm font-medium text-zinc-700">
                  Notes (optional)
                </label>
                <textarea
                  id="play-notes"
